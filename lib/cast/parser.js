...
class ConventionalCommitParser extends CstParser {
  ...
  , tokens
    ...
    // Trailer key: BREAKING_CHANGE or FOOTER_TOKEN
    this.RULE('trailerkey', () => {
      this.OR([
        {ALT: () => {
          return this.CONSUME(BREAKING_CHANGE)
        }}
      , {ALT: () => {
...
module.exports = ConventionalCommitParser
